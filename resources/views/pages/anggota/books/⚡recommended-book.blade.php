...
<section id="rekomendasi" aria-labelledby="rekomendasi"
    ...
    <div class="grid gap-6 lg:grid-cols-3 items-start">
        ...
        @if ($this->books->isNotEmpty())
            <div class="lg:col-span-2 flex flex-col gap-6">
                <div class="flex items-center gap-2 text-sm text-gray-500">
                    <span class="font-medium text-gray-700">Rekomendasi Buku Terbaru</span>
                    <span class="px-2 py-0.5 bg-gray-200 rounded-full">{{ $this->books->count() }}</span>
                </div>
                <!-- CAROUSEL SPLIT -->
                <div x-data="{
                    current: 0,
        ...
        @else
            <div class="lg:col-span-2 p-6 rounded-2xl bg-white/90 shadow-lg border border-gray-100 text-center">
